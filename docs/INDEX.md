...
| [PARALLEL_DEVELOPMENT.md](PARALLEL_DEVELOPMENT.md) | N agents building in parallel without collisions: phases, formal plan format v3 (crash points, failure planes), the 19 validity rules and `POST /system/plan/validate` |
