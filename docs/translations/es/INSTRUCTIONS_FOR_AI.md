...
> [!IMPORTANT]
> **Archivos Sagrados (Sacred Files)**: Los archivos dentro de `/core` (Kernel, Container, Registry) son SAGRADOS. 
> - **NUNCA** los modifiques para añadir lógica de observabilidad, trazabilidad o salud.
> - La arquitectura está diseñada para que la inteligencia crezca en los Plugins y las Tools.
> - Si necesitas observar el sistema, usa el `event_bus` o el `registry` desde un Plugin dedicado.
